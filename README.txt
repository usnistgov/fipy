...
|FiPy| is freely available for download at sourceforge_ via CVS_ or as
a tarball. |FiPy| also has a home webpage_.

------------
Installation
------------

Please refer to the installation guide_ (INSTALATION.txt) or the manual_.
...
(documentation/manual/fipy.pdf). A fresh copy of the manual_ can be
built with the use of epydoc_ by issuing the following commands in the
base directory:
...
.. _webpage:     http://www/ctcms.nist.gov/fipy/
.. _CVS:         http://cvs.sourceforge.net/viewcvs.py/fipy/
.. _sourceforge: http://sourceforge.net/projects/fipy/
.. _manual:      http://www.ctcms.nist.gov/fipy/manual.pdf
.. _guide:       http://www.ctcms.nist.gov/fipy/installation.html
