...
- :term:`Mayavi` 2 is now supported, including an independent viewer process that 
...
:class:`~fipy.meshes.numMesh.grid2D.Grid2D`, or
:class:`~fipy.meshes.numMesh.cylindricalGrid2D.CylindricalGrid2D`,
...
* It should not generally be necessary to change anything in your script; simply 
  invoke::
