...
.. image:: /figures/examples/diffusion/electrostatics/uniform.*
   :width: 90%
   :align: center
...
.. image:: /figures/examples/diffusion/electrostatics/right.*
   :width: 90%
   :align: center
...
.. image:: /figures/examples/diffusion/electrostatics/left.*
   :width: 90%
   :align: center
