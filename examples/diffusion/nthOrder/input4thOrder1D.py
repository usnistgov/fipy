...
## 
 ...
 #                                last update: 9/3/04 {10:35:58 PM} 
...
Test the solution:
   ...
   >>> answer = alpha4 / 6. * x**3 + alpha3 / 2. * x**2 + (alpha2 - alpha4 / 2. * L**2 - alpha3 * L) * x + alpha1
   >>> Numeric.allclose(Numeric.array(answer), Numeric.array(var), atol = 1e-10)
   1
