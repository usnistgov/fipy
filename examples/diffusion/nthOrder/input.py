...
## 
 ...
 #                                last update: 6/15/04 {11:51:58 AM} 
...
eq = NthOrderDiffusionEquation(var,
                       ...
                       boundaryConditions = (FixedValue(mesh.getFacesLeft(),valueLeft),
					     NthOrderBoundaryCondition(mesh.getFacesLeft(), curvatureLeft, 2),		       
                                             FixedValue(mesh.getFacesRight(),valueRight),
					     NthOrderBoundaryCondition(mesh.getFacesRight(), curvatureRight, 2),		       
