...
.. raw:: latex
   ...
   From the main equation, the flux into the domain at $x=0$ is given
   by
   ...
   Using the boundary condition at $x=0$ this flux should be equal to
   $-P$. Setting the $x=1$ boundary condition to be a fixed value
   equal to $C \left( 1 \right)$ fixes the edge derivative on both the
