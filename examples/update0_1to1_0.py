...
`examples/convection/exponential1D/input.py` from :term:`FiPy` 0.1. If you attempt to
...
Although no error was generated by the use of `Grid2D`, :term:`FiPy` 1.0 supports
...
The biggest change between :term:`FiPy` 0.1 and :term:`FiPy` 1.0 is that `Equation`
