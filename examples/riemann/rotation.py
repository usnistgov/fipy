...
This example demonstrates the use to the RoeConvectionTerm for a
single equation. The example is from the Clawpack code and the results
...
The intial conditions are shown in the image below. 
