...
class AdvectionTerm(_NonDiffusionTerm):
    r"""
    ...
    >>> v, L, b = AdvectionTerm(0.)._buildMatrix(var, SparseMatrix)
    ...
    >>> v, L, b = AdvectionTerm(1.)._buildMatrix(var, SparseMatrix)
    ...
    >>> v, L, b = AdvectionTerm(vel)._buildMatrix(var, SparseMatrix)
    ...
    def _getDefaultSolver(self, var, solver, *args, **kwargs):
        solver = solver or super(AdvectionTerm, self)._getDefaultSolver(var, solver, *args, **kwargs)
