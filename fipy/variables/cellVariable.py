...
class CellVariable(_MeshVariable):
    ...
    def getMinmodFaceValue(self):
        ...
        Returns a `FaceVariable` whose value is the value in the
        adjacent cell with the minimum of the absolute values of the
        adjacent cells. If the values are of opposite sign then the
        result is zero:
