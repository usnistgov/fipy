...
class MayaviVectorViewer(_MayaviViewer):
    """Displays a plot of a rank-1 `CellVariable` object
    of any dimension using Mayavi

    .. Mayavi: http://code.enthought.com/projects/mayavi/docs/development/html/mayavi/index.html

    """
    __doc__ += _MayaviViewer._test2Dvector(viewer="MayaviVectorViewer")
    __doc__ += _MayaviViewer._test2DvectorIrregular(viewer="MayaviVectorViewer")

    def __init__(self,vars,title=None,limits={},**kwargs):
        """Creates a MayaviVectorViewer
