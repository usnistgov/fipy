...
\end{verbatim}
    ...
    \section{How do I change \FiPy{}'s default behavior?}
        ...
        wish to override these behaviors. \FiPy{} looks for the 
        following:
        \subsection{Command-line Flags}
        \begin{description}
            \item[\texttt{--cache}] Causes the value of a calculated 
            \Class{Variable} expression to be cached in memory, 
...
\end{verbatim}
        ...
        \begin{description}
            ...
            the graphical displays the solution matrix of each
