...
\end{verbatim}
    ...
    simply use a \Class{FixedFlux} condition and multiply through by the diffusion
    coefficient to create the boundary condition,
\begin{verbatim}
FixedFlux(value=diffusionCoeff * gradient, faces=myFaces)
\end{verbatim}
