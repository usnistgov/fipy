...
\end{verbatim}
    The \verb+BCs+ list can then be passed to the \verb+solve+ when its called,
\begin{verbatim}
>>> eqn.solve(..., boundaryConditions=BCs)
\end{verbatim}
    Further demonstrations of spatially varying boundary condition can be found
    are in Example~\ref{sec:Examples:diffusion:mesh20x20}
...
%    \subsection{Internal boundary conditions}
    ...
    \section{How do I change \FiPy{}'s default behavior?}
        ...
        \begin{description}
            ...
            \Class{Variable} expression to be stored in memory, 
            ...
            storing of the value of a calculated \Class{Variable}
