...
\end{verbatim}
          Notice that the tensor, written in the form of a list, is
          contained within a list. This is because the first index of
          the list refers to the order of the term not the first index
          of the tensor (see the FAQ,
          Chapter~\ref{subsection:higherOrderDiffusion}
          ``\titleref{subsection:higherOrderDiffusion}''). This
...
\end{verbatim}
              ...
              The vector notation is just a short-hand representation for
              the diagonal of the tensor. Off-diagonals are assumed to
              be zero.
...
\end{verbatim}
              ...
              term of the form $\partial_x^2 \partial_y^2 \phi$, but
              \FiPy{} does not currently support anisotropy for higher
              order diffusion terms so this may well throw an error or
