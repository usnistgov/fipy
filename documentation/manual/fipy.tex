...
\usepackage[tocAsPDFchapter,index,bookmarksdepth=subsection]{fipy}


\externaldocument[API-]{reference}[http://matforge.org/fipy/wiki/FiPyManual]
...
\input{examples/latex/examples.convection.source-module}
...
\input{examples/latex/examples.cahnHilliard.mesh2D-module}
\label{sec:Examples:cahnHilliard:mesh2D}
\input{examples/latex/examples.cahnHilliard.sphere-module}
% \newpage
...
\input{examples/latex/examples.update1_0to2_0-module}
