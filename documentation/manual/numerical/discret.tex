...
\begin{figure}
 \begin{center}
%  \resizebox{8cm}{!}{\includegraphics[width=8cm]{numerical/meshcartoon.pdf}}
...
restrictions as the CC-FVM. \FiPy{} does not have a VC-FVM capability.

Future releases of \FiPy{} will have both
