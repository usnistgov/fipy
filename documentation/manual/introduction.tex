...
at running a given task than high-level languages, but they take
longer to write and debug.  Because running performance is a paramount
concern, most scientific codes are written in low-level compiled
